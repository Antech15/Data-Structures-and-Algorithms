...
int main()
{ 
  cout << "This program will be used for employers, schools, or hosptials to store the information and contact information for their workers, students, or clients." << endl; // cout an explanation of what this App should be used for. 
  ...
  cin >> selection;
    ...
    case 1:  // Add and indicate slot
      cout << "What is the password to add? ";
      cin >> thekey;
      ...
      theelement = el_t(thekey, thename, thephone, theage);
      s = HT.add(theelement);
      cout << "Added the info in slot " << s << endl;
      break;

    case 2: // Find and indicate element
      cout << "What is the password to find? ";
      cin >> thekey;
