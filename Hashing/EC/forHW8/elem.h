...
class el_t
{
 private:  // these will change depending
  ...
  string phone; //customer ssn
  int age; //customer phone number


 public:

  el_t();  // to create a blank el_t object
  el_t(string, string, string, int); // to create an initialized el_t object - useful for the client   ** add more arguments to create the object
